...
//
// Adapted from $GOROOT/src/net/dnsconfig.go (see ./README.md). Material
...
//
// fork: dropped the //go:linkname directive and the "hall of shame"
// note — those exist in upstream to keep accidental external linkname
// consumers working; nothing here links to us.
